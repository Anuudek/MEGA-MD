...
// CLOUDRON_MONGODB_URL is auto-injected by Cloudron's mongodb addon;
// MONGO_URL stays supported for anyone bringing their own external Mongo.
const MONGO_URL = process.env.CLOUDRON_MONGODB_URL || process.env.MONGO_URL;
